...
\author{Marta Aguilera Anguita \\ Begoña Carcedo Avedillo \\ Andoni Martín Reboredo \\ David Ramirez Ambrosi}
\title{\begin{center}
\textbf{\Huge{Práctica 3, Clasificación: \\ Modelos OneR y \\ SVM }} \\ \includegraphics{./figs/svm.png}\\ \textbf{Sistemas de Apoyo a la Decisión}
\end{center}}
\date{\today}
...
\pagestyle{fancy}
\rhead{
\textbf{Sistemas de Apoyo a la Decisión} \hfill \textbf{Grupo de laboratorio 1}\\
Práctica 3: Clasificación \hfill \textbf{Fecha:} \date{\today}
}
