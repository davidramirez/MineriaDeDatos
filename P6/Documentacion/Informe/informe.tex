...
\chapter{Resultados experimentales}
	...
	\begin{center}
		...
		\hline
		2	&	559.6037	&	555.6380	&	417.3507	&	555.6380 & \\
		\hline
		3	&	726.4665	&	799.9119	&	732.8291	&	759.2235 & \\
		\hline
		4	&	1011.9005	&	975.9922	&	1047.5332	&	730.4880 & \\
		\hline
		5	&	982.6874	&	1220.2895	&	917.7001	&	911.4739 & \\
		\hline
		\end{tabular}
		
		\caption{Resultados para el fichero de pruebas \textit{colon.csv}}
		\label{res_colon}
	\end{center}
	...
	\begin{center}
		...
		K	&	Aleatoria	&	Pert aleatoria	&	Cent aleatoria	&	Particionada & Weka\\
		\hline
		2	&	4.5291	&	4.5291	&	4.5291	&	4.5291 & \\
		\hline
		3	&	5.6385	&	6.9322	&	6.6599	&	5.6385 & \\
		\hline
		4	&	7.1510	&	4.1677	&	4.1480	&	4.1677 & \\
		\hline
		5	&	4.7109	&	7.3777	&	4.2406	&	4.8980 & \\
		\hline
		\end{tabular}
		
		\caption{Resultados para el fichero de pruebas \textit{food.csv}}
		\label{res_food}
	\end{center}
	...
	Los valores del error en las 10000 repeticiones varían en el intervalo [4.148, 7.843], siendo la media 6.181. En la figura \ref{fig:error} se muestran de forma gráfica los resultados mediante un histograma con la densidad de los diferentes valores
