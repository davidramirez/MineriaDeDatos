...
\chapter{Resultados experimentales}
	...
	Para cada una de las combinaciones de parámetros tratadas,  se ha ejecutado 1000 veces, obteniéndose en cada una el valor del error cuadrático medio.
	...
	Posteriormente, los 1000 valores de cada ejecución se han tratado con el software R para obtener  las medidas estadísticas deseadas.
...
\chapter{Conclusiones}
	...
	También teníamos un problema con la representación de los resutados, ya que los valores reales se presentaban con todos los decimales que tuvieran. Esto fue solucionado en la semana extra, haciendo que al imprimir los vallores, se redondeasen previamente a 3 o 5 decimales.
